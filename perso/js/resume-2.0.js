 (function() {
   ...
   var createDate = function(strDate){
		if(strDate == undefined || "") return new Date();
    ...
    var paper;
    var divi = 2.9; //2.7; //TODO calculate it
    var config = {
        start_date: createDate('2005-05-01'),
        end_date: createDate('2012-07-01'), //new Date(),
	...
	box.content = [];
	box.content.popup = paper.g.popup(920-8, 220, "Resume 2.0 JS developed by Remy Mellet. Fork me on https://github.com/remmel/Resume-2.0", 1).hide();
        box.hover(hover_in, hover_out);
    }
})();
